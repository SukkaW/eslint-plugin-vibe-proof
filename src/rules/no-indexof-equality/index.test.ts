...
runTest({
  ...
  valid: [
    ...
    // Dynamic comparison indexes.
    'declare const arr: number[]; declare let index: number; arr.indexOf(2) === index;',
    'declare const str: string; declare let index: number; str.indexOf("h") === index;',

    // Spread arguments cannot be converted to direct access.
    'declare const arr: number[]; declare const args: [number]; arr.indexOf(...args) === 0;',
  ...
  invalid: [
    {
      code: 'const arr: number[] = [1, 2, 3]; const index = 1; arr["indexOf"](2) === index;',
      output: 'const arr: number[] = [1, 2, 3]; const index = 1; arr[1] === 2;',
      errors: [{ messageId: 'preferDirectAccess' }]
    },
    {
      code: 'const str: string = "hello"; const index = 0; str.indexOf("h") === index;',
      output: 'const str: string = "hello"; const index = 0; str.startsWith("h");',
